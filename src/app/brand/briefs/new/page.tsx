          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-4 text-xs">
              <div>
                ...
                <input
                  type="text"
                  placeholder="e.g. Rice Water & Niacinamide Serum Launch"
                  value={title}
              ...
              <div>
                ...
                <textarea
                  placeholder="Describe what makes your product unique and the key messaging to highlight in the video..."
                  value={description}
              ...
              <div>
                ...
                <input
                  type="text"
                  placeholder="e.g. Skincare enthusiasts & working professionals aged 20-35"
