...
import { Building2, Video, Plus, ShieldCheck, Clock, ArrowRight, Eye, Users } from "lucide-react";
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10 space-y-8">
      ...
      <div className="bg-white border border-[#E8DEC8] rounded-3xl p-6 sm:p-8 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-6">
        ...
        <Link
          ...
          className="px-5 py-3 rounded-full bg-[#7A1C28] hover:bg-[#63141E] text-white text-xs font-bold shadow-md transition flex items-center gap-2 self-start md:self-auto"
        >
