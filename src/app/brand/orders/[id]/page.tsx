...
import { ShieldCheck, CheckCircle2, ArrowLeft, Award, FileCheck } from "lucide-react";
...
export default function BrandOrderRoomPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 space-y-8">
      ...
      {showApprovedSuccess && (
        <div className="bg-[#EBF7EE] border-2 border-[#16A34A] rounded-2xl p-6 shadow-md text-[#166534] space-y-2">
