          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-4 text-xs">
              ...
              <div>
                ...
                <input
                  type="text"
                  placeholder="e.g. Summer D2C Whey Isolate Launch"
                  value={title}
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      min={5000}
                      step={1000}
                      className="w-full text-xs pl-7 pr-3 py-3 rounded-xl border border-[#E8DEC8] bg-[#FAF6EE] font-mono font-bold text-[#181314] focus:outline-none"
                      required
                    />
                  </div>
                </div>
              ...
              <div>
                ...
                <textarea
                  placeholder="Describe your product, core benefits, and what kind of creative energy you are looking for..."
                  value={description}
              ...
              <div>
                ...
                <input
                  type="text"
                  placeholder="e.g. Gymgoers & college students aged 18-32 in Tier 1 & 2 cities"
              ...
              <div>
                ...
                <textarea
                  placeholder="e.g. No fake beauty filters; demonstrate product solubility in cold water..."
                  value={guidelines}
