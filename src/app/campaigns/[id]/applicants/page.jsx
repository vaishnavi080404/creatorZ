...
export default function CampaignApplicantsPage({ params }) {
    ...
    return (<div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <Link href={`/campaigns/ord-8492/room`} className="text-xs font-bold px-4 py-2 rounded-full border border-[#D8CEBD] bg-white text-[#181314] hover:bg-[#FAF6EE] transition">
      ...
      <AuditionDeck pitchReels={MOCK_PITCH_REELS} campaignTitle={brief.title}/>
