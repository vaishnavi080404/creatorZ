...
export default function CreatorApplyBriefPage({ params }: ApplyBriefProps) {
  ...
  const [pitchSummary, setPitchSummary] = useState<string>("I will shoot a fast-paced workplace vs. gym sketch comparing terrible clumpy protein vs. BeastLife instant dissolution in cold water.");
              ...
              <div className="lg:col-span-7 space-y-4 text-xs">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full text-xs p-3 rounded-xl border border-[#E8DEC8] bg-[#FAF6EE] text-[#181314] focus:outline-none"
                    required
                  />
                </div>
