...
export default function CreatorBriefsPage() {
    return (<div className="max-w-7xl mx-auto px-4 sm:px-6 py-10 space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {MOCK_OPEN_BRIEFS.map((brief) => (<div key={brief.id} className="bg-white border border-[#E8DEC8] rounded-2xl p-6 shadow-sm flex flex-col justify-between space-y-6">
            ...
            <div className="pt-4 border-t border-[#F0E8D8] flex items-center justify-between">
              ...
              <Link href={`/creator/briefs/${brief.id}/apply`} className="px-4 py-2 rounded-xl bg-[#7A1C28] hover:bg-[#63141E] text-white font-bold text-xs shadow-sm transition flex items-center gap-1.5">
