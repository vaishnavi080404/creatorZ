    ...
    return (<div className="max-w-7xl mx-auto px-4 sm:px-6 py-10 space-y-8">
      ...
      <div className="bg-white border border-[#E8DEC8] rounded-3xl p-6 sm:p-8 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div className="flex items-center gap-4">
          <img src={creator.avatar} alt={creator.name} className="w-16 h-16 rounded-2xl object-cover border-2 border-[#E8DEC8] shadow-sm"/>
          <div>
        ...
        <div className="flex items-center gap-3">
          <Link href="/creator/briefs" className="px-5 py-3 rounded-full bg-[#7A1C28] hover:bg-[#63141E] text-white text-xs font-bold shadow-md transition flex items-center gap-2">
            <Video className="w-4 h-4"/>
            <span>Audition for Briefs</span>
          </Link>

          <Link href="/creator/portfolio" className="px-5 py-3 rounded-full bg-[#FAF6EE] hover:bg-[#F2EAE0] border border-[#D8CEBD] text-[#181314] text-xs font-bold transition flex items-center gap-1.5">
        ...
        <div className="lg:col-span-7 bg-white border border-[#E8DEC8] rounded-3xl p-6 shadow-sm space-y-6">
          ...
          <div className="space-y-4">
            {MOCK_OPEN_BRIEFS.map((brief) => (<div key={brief.id} className="p-4 rounded-2xl bg-[#FAF6EE] border border-[#E8DEC8] flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <Link href={`/creator/briefs/${brief.id}/apply`} className="px-4 py-2 rounded-xl bg-[#7A1C28] hover:bg-[#63141E] text-white font-bold text-xs shadow-sm transition flex items-center justify-center gap-1.5 flex-shrink-0">
