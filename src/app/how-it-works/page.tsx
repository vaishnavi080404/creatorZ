...
import { ShieldCheck, Video, Award, Clock, ArrowRight, FileCheck } from "lucide-react";
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 space-y-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {lifecycle.map((step) => (
            <div
              key={step.stage}
              className="bg-white border border-[#E8DEC8] rounded-3xl p-6 shadow-sm space-y-3"
            >
