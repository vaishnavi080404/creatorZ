    ...
    return (<div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 space-y-6">
      ...
      <div className="flex items-center justify-between pb-4 border-b border-[#E8DEC8]">
        ...
        <div className="flex items-center gap-2">
          <Link href="/campaigns/ord-8492/room" className="text-xs font-bold px-4 py-2 rounded-full bg-[#FAF6EE] hover:bg-[#F2EAE0] border border-[#E8DEC8] text-[#7A1C28]">
      ...
      <div className="bg-white border border-[#E8DEC8] rounded-3xl overflow-hidden shadow-sm grid grid-cols-1 lg:grid-cols-12 min-h-[640px]">
        ...
        <div className="lg:col-span-4 border-b lg:border-b-0 lg:border-r border-[#E8DEC8] bg-[#FAF6EE] flex flex-col justify-between">
          <div>
            <div className="p-4 border-b border-[#E8DEC8]">
              <input type="text" placeholder="Search conversations..." className="w-full text-xs px-3.5 py-2 rounded-xl bg-white border border-[#E8DEC8] text-[#181314] focus:outline-none"/>
            </div>
            ...
            <div className="divide-y divide-[#E8DEC8]">
              ...
              <div className="p-4 bg-white border-l-4 border-[#7A1C28] cursor-pointer">
                <div className="flex items-start justify-between">
                  <div className="flex items-center gap-3">
                    <img src="https://images.unsplash.com/photo-1551024709-8f23befc6f87?w=100&auto=format&fit=crop&q=80" alt="Prime India" className="w-10 h-10 rounded-xl object-cover border border-[#E8DEC8]"/>
                    <div>
              ...
              <div className="p-4 hover:bg-white/60 transition cursor-pointer">
                <div className="flex items-start justify-between">
                  <div className="flex items-center gap-3">
                    <img src="https://images.unsplash.com/photo-1579758629938-03607ccdbaba?w=100&auto=format&fit=crop&q=80" alt="BeastLife" className="w-10 h-10 rounded-xl object-cover border border-[#E8DEC8]"/>
                    <div>
              ...
              <div className="p-4 hover:bg-white/60 transition cursor-pointer">
                <div className="flex items-center gap-3">
                  <img src="https://images.unsplash.com/photo-1590658268037-6bf12165a8df?w=100&auto=format&fit=crop&q=80" alt="Boat Audio" className="w-10 h-10 rounded-xl object-cover border border-[#E8DEC8]"/>
                  <div>
        ...
        <div className="lg:col-span-8 flex flex-col justify-between bg-white">
          ...
          <div className="p-4 border-b border-[#E8DEC8] flex items-center justify-between bg-[#FAF6EE]/50">
            <div className="flex items-center gap-3">
              <img src="https://images.unsplash.com/photo-1551024709-8f23befc6f87?w=100&auto=format&fit=crop&q=80" alt="Prime India" className="w-9 h-9 rounded-xl object-cover border border-[#E8DEC8]"/>
              <div>
          ...
          <div className="p-6 space-y-6 overflow-y-auto max-h-[500px]">
            {messages.map((msg) => (<div key={msg.id} className={`flex flex-col ${msg.sender === "creator" ? "items-end" : "items-start"}`}>
                <span className="text-[10px] font-mono text-[#6C635B] mb-1 px-1">
                  {msg.senderName} • {msg.time}
                </span>

                {msg.isOffer ? (<div className="w-full my-2">
                    <StructuredOfferCard offer={MOCK_OFFERS[0]}/>
                  </div>) : (<div className={`max-w-md p-3.5 rounded-2xl text-xs leading-relaxed ${msg.sender === "creator"
          ...
          <form onSubmit={handleSendMessage} className="p-4 border-t border-[#E8DEC8] bg-[#FAF6EE] flex items-center gap-3">
            <input type="text" placeholder="Type message or discuss deliverable terms..." value={inputMessage} onChange={(e) => setInputMessage(e.target.value)} className="flex-1 text-xs p-3 rounded-xl border border-[#E8DEC8] bg-white text-[#181314] focus:outline-none focus:border-[#7A1C28]"/>
            
            <button type="submit" className="px-5 py-3 rounded-xl bg-[#7A1C28] hover:bg-[#63141E] text-white font-bold text-xs flex items-center gap-1.5 shadow-sm transition">
