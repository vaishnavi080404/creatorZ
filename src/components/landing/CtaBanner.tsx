      ...
      <div className="bg-[#66101b] rounded-3xl p-8 sm:p-16 text-[#faf3eb] text-center space-y-8 shadow-2xl relative overflow-hidden border border-[#851825]">
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 relative z-10 pt-2">
          <Link
            ...
            className="px-8 py-4 rounded-xl bg-[#faf3eb] text-[#66101b] font-bold text-sm shadow-lg hover:bg-white transition flex items-center gap-2.5 transform active:scale-98"
          >
          ...
          <Link
            ...
            className="px-8 py-4 rounded-xl bg-white/10 border border-[#faf3eb]/30 text-[#faf3eb] font-bold text-sm hover:bg-white/20 transition flex items-center gap-2.5 transform active:scale-98 backdrop-blur-sm"
          >
