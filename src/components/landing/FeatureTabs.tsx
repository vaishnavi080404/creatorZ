...
import { Building2, UserCheck, Check, ArrowUpRight, ShieldCheck, Video, Award, Clock } from "lucide-react";
      ...
      <div className="flex justify-center">
        <div className="bg-[#f3e8dc] p-1.5 rounded-2xl border-2 border-[#e4d0c0] flex items-center gap-1.5 shadow-xs">
          <button
            ...
            className={`px-7 py-3 rounded-xl text-xs sm:text-sm font-bold transition-all flex items-center gap-2 cursor-pointer ${
              activeTab === "brand"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              {(activeTab === "brand" ? brandFeatures : creatorFeatures).map((feat, i) => (
            ...
            <div className="pt-3">
              <Link
                href={activeTab === "brand" ? "/brand/dashboard" : "/creator/dashboard"}
                className="inline-flex items-center gap-2 px-8 py-3.5 rounded-xl bg-[#66101b] hover:bg-[#4d0a13] text-[#faf3eb] text-xs sm:text-sm font-bold shadow-md transition transform active:scale-98"
              >
