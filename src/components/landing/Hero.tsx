...
export default function Hero() {
  return (
    <section className="relative overflow-hidden pt-10 pb-16 md:pt-14 md:pb-24 bg-[#faf3eb]">
      <div className="max-w-7xl mx-auto px-6 sm:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-7 max-w-2xl text-left">
            ...
            <motion.h1
              initial={{ filter: "blur(8px)", opacity: 0.001, y: 40 }}
              animate={{ filter: "blur(0px)", opacity: 1, y: 0 }}
              transition={{ delay: 0.1, duration: 0.6, ease: HOOKK_EASE }}
              className="text-5xl sm:text-7xl lg:text-[84px] font-bold tracking-[-0.03em] font-heading leading-[1.02]"
            >
            ...
            <motion.p
              initial={{ filter: "blur(4px)", opacity: 0.001, y: 40 }}
              animate={{ filter: "blur(0px)", opacity: 1, y: 0 }}
              transition={{ delay: 0.25, duration: 0.6, ease: HOOKK_EASE }}
              className="text-base sm:text-lg text-[#82575c] leading-relaxed max-w-xl font-normal"
            >
            ...
            <motion.div
              ...
              transition={{ delay: 0.35, duration: 0.6, ease: HOOKK_EASE }}
            ...
            >
              {[
                ...
                <span
                  ...
                  className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/90 border border-[#e4d0c0] text-[11px] sm:text-xs font-medium text-[#66101b] shadow-2xs"
                >
            ...
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.45, duration: 0.6, ease: HOOKK_EASE }}
              className="flex flex-wrap items-center gap-4 pt-1"
            >
              <Link
                href="/brand/briefs/new"
                className="px-8 py-4 rounded-xl bg-[#66101b] hover:bg-[#4d0a13] text-[#faf3eb] text-sm sm:text-base font-semibold transition-all transform active:scale-98 flex items-center gap-2.5 shadow-md group"
              >
              ...
              <Link
                ...
                className="px-8 py-4 rounded-xl bg-[#f3e8dc] hover:bg-white border-2 border-[#e4d0c0] text-[#66101b] text-sm sm:text-base font-semibold transition shadow-xs flex items-center gap-2"
              >
            ...
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.55, duration: 0.6, ease: HOOKK_EASE }}
              className="flex items-center gap-6 text-xs font-mono text-[#82575c] pt-1"
            >
            ...
            <motion.div
              initial={{ opacity: 0.001, y: 40 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.65, duration: 0.6, ease: HOOKK_EASE }}
              className="pt-6 border-t border-[#e4d0c0] space-y-2"
            >
          ...
          <div className="lg:col-span-5 relative flex items-center justify-center pt-4 lg:pt-0">
            ...
            <motion.div
              initial={{ opacity: 0.001, rotate: 10, x: 80, y: 120 }}
              animate={{ opacity: 1, rotate: 0, x: 0, y: 0 }}
              transition={{ delay: 0.3, duration: 0.7, ease: HOOKK_EASE }}
              className="relative w-full max-w-[370px] sm:max-w-[430px] aspect-[2320/3264] mx-auto flex items-center justify-center"
            >
              
              {/* Screen Area: Positioned precisely inside the phone's transparent screen cutout */}
              <div 
                className="absolute overflow-hidden rounded-[24px] sm:rounded-[32px] z-10 bg-black"
                style={{
                  left: "38.32%",
                  top: "1.75%",
                  width: "48.97%",
              ...
              <img
                ...
                alt="Hand holding smartphone displaying creator audition video"
              ...
              <motion.div
                ...
                className="absolute left-1 sm:left-3 top-[17%] z-30 bg-white/95 backdrop-blur-md rounded-2xl py-3 px-3.5 sm:py-3.5 sm:px-4 shadow-xl border border-[#e4d0c0] flex flex-col items-center gap-1 min-w-[72px] sm:min-w-[80px] cursor-default"
              >
              ...
              <motion.div
                initial={{ opacity: 0, scale: 0.6, y: 15 }}
                animate={{ opacity: 1, scale: 1, y: 0 }}
                transition={{ delay: 0.75, duration: 0.5, type: "spring", stiffness: 260, damping: 20 }}
                whileHover={{ scale: 1.05 }}
                className="absolute -right-2 sm:right-0 top-[23%] z-30 bg-white/95 backdrop-blur-md rounded-2xl py-3 px-3.5 sm:py-3.5 sm:px-4 shadow-xl border border-[#e4d0c0] flex flex-col items-center gap-1 min-w-[72px] sm:min-w-[80px] cursor-default"
              >
              ...
              <motion.div
                initial={{ opacity: 0, scale: 0.6, y: 15 }}
                animate={{ opacity: 1, scale: 1, y: 0 }}
                transition={{ delay: 0.9, duration: 0.5, type: "spring", stiffness: 260, damping: 20 }}
                whileHover={{ scale: 1.05 }}
                className="absolute right-4 sm:right-8 bottom-[20%] z-30 bg-white/95 backdrop-blur-md rounded-2xl py-3 px-3.5 sm:py-3.5 sm:px-4 shadow-xl border border-[#e4d0c0] flex flex-col items-center gap-1 min-w-[72px] sm:min-w-[80px] cursor-default"
              >
