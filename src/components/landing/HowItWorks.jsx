    ...
    const steps = [
        {
            ...
            description: "Brands publish open briefs with target deliverables and clear budgets. Creators apply with high-energy 30–60s video audition hooks. Review applicant creativity in a fast 9:16 swipe interface.",
        ...
        },
        {
            ...
            description: "Before production starts, both parties lock the milestone terms. Creators start filming knowing deliverables and rates are legally confirmed, and brands maintain full approval control.",
        ...
        },
        {
            ...
            description: "No more messy Google Drive links or confusing WhatsApp voice notes. Scrub through creator drafts and click directly on the timeline at exact seconds (e.g. 0:14) to leave actionable revision pins.",
        ...
        },
        {
            ...
            description: "Upon final approval, payout is disbursed directly to the creator. The approved reel automatically converts into a verified case study on the creator's profile with confirmed brand attribution and metrics.",
    ...
    return (<section className="bg-[#f3e8dc] border-y border-[#e4d0c0] py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 space-y-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {steps.map((s, i) => {
            const Icon = s.icon;
            return (<div key={i} className="bg-white/95 border-2 border-[#e4d0c0] rounded-3xl p-7 shadow-soft-floating flex flex-col justify-between hover:border-[#66101b] hover:shadow-card-elevated transition-all group">
        ...
        <div className="text-center pt-4">
          <Link href="/how-it-works" className="inline-flex items-center gap-2 text-xs font-bold text-[#66101b] hover:text-[#4d0a13] font-mono uppercase tracking-wider transition group">
