export default function LogoMarquee() {
    ...
    return (<section className="border-y border-[#E8DEC8] bg-[#F5E6C0]/30 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 text-center space-y-4">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-6 items-center justify-center">
          {brands.map((brand, i) => (<div key={i} className="p-3 rounded-xl hover:bg-white/60 transition group text-center">
