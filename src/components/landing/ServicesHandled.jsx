...
export default function ServicesHandled() {
    ...
    return (<section className="relative bg-[#faf3eb] py-24 sm:py-32 border-b border-[#e4d0c0] overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4">
          ...
          <motion.div initial={{ opacity: 0.001, y: 80 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.3 }} transition={{ delay: 0.1, duration: 0.6, ease: HOOKK_EASE }} className="inline-flex items-center gap-2 px-3 py-1 rounded-md bg-[#eddcd0] border border-[#e4d0c0] text-[#66101b] text-xs font-mono font-bold tracking-wider uppercase">
          ...
          <motion.h2 initial={{ filter: "blur(16px)", opacity: 0.001, y: 80 }} whileInView={{ filter: "blur(0px)", opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.3 }} transition={{ delay: 0.2, duration: 0.6, ease: HOOKK_EASE }} className="text-4xl sm:text-6xl lg:text-[68px] font-bold font-heading text-black leading-[1.06] tracking-tight">
          ...
          <motion.p initial={{ filter: "blur(4px)", opacity: 0.001, y: 80 }} whileInView={{ filter: "blur(0px)", opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.3 }} transition={{ delay: 0.3, duration: 0.6, ease: HOOKK_EASE }} className="text-sm sm:text-base text-[#82575c] leading-relaxed max-w-xl mx-auto font-normal">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
          ...
          <div className="lg:col-span-5 flex justify-center items-center">
            <motion.div initial={{ opacity: 0.001, rotate: -12, x: -120, y: 160 }} whileInView={{ opacity: 1, rotate: 0, x: 0, y: 0 }} viewport={{ once: true, amount: 0.25 }} transition={{ delay: 0.3, duration: 0.6, ease: HOOKK_EASE }} className="relative w-full max-w-[340px] sm:max-w-[380px] aspect-[2320/3264] flex items-center justify-center">
              
              {/* Looping Creator Video playing behind the phone screen cutout */}
              <div className="absolute z-10 overflow-hidden bg-black shadow-inner" style={{
            left: "38.32%",
            top: "1.75%",
            width: "48.97%",
            height: "75.74%",
            borderRadius: "28px"
                ...
                <video src="/creator-reel.mp4" autoPlay loop muted playsInline className="w-full h-full object-cover"/>
              ...
              <img src="/phone-in-hand.png" alt="Hand holding smartphone with creator audition" className="w-full h-full object-contain relative z-20 pointer-events-none drop-shadow-2xl"/>
          ...
          <div className="lg:col-span-7 space-y-4">
            ...
            return (<motion.div key={item.id} initial={{ opacity: 0, y: 80 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.2 }} transition={{ delay: item.delay, duration: 0.6, ease: HOOKK_EASE }} whileHover={{
                    scale: 1.02,
            ...
            <motion.div initial={{ opacity: 0, y: 80 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.2 }} transition={{ delay: fullWidthService.delay, duration: 0.6, ease: HOOKK_EASE }} whileHover={{
            scale: 1.02,
            transition: { duration: 0.2, ease: HOOKK_EASE }
        }} className="bg-white/95 border-2 border-[#e4d0c0] rounded-3xl p-6 sm:p-7 shadow-xs hover:border-[#66101b] hover:shadow-card-elevated transition-colors duration-200 space-y-3 group cursor-default">
              <div className="w-11 h-11 rounded-2xl bg-[#66101b] text-[#faf3eb] flex items-center justify-center shrink-0 shadow-xs transition-transform group-hover:scale-105">
