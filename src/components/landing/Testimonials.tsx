...
import { Star, ShieldCheck, CheckCircle2, TrendingUp, Building2, UserCheck } from "lucide-react";
...
export default function Testimonials() {
  ...
  const testimonials = [
    {
      type: "brand",
      quote:
        "We spent two months working with an influencer agency that charged 35% commission and gave us delayed Google Drive links. On CreatorZ, we published a brief on Monday, watched 12 Pitch Reels that evening, and approved two final cuts by Friday.",
      author: "Tanya Sharma",
    ...
    },
    {
      type: "creator",
      quote:
        "The milestone contract system is a life-changer. In the past, I had to chase brands on WhatsApp for 90 days after delivering videos. Here, milestones and rates are locked before I even pick up my camera. Once they approve the video, the payout is processed smoothly.",
      author: "Vikram Joshi",
    ...
    },
    {
      type: "brand",
      quote:
        "The In-App Video Review Studio alone saves our creative team 10 hours a week. Being able to scrub through a draft, click at timestamp 0:14, and write 'brighten the product label' completely eliminated 4 rounds of confusing WhatsApp voice notes.",
      author: "Aryan Mehta",
      role: "Founder & CEO",
    ...
    },
    {
      type: "creator",
      quote:
        "Portfolio-From-Delivery™ changed how I pitch. I don't build Canva PDF decks anymore. Every brand deliverable automatically becomes a verified case study with confirmed view counts. Brands reach out directly because they can see real proof.",
      author: "Sneha Rao",
  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 py-24 space-y-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {testimonials.map((t, i) => (
          <div
            key={i}
            className="bg-white/95 border-2 border-[#e4d0c0] rounded-3xl p-8 shadow-soft-floating flex flex-col justify-between space-y-6 hover:border-[#66101b] transition-all"
          >
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-1 text-amber-600">
                  {[...Array(5)].map((_, idx) => (
                    <Star key={idx} className="w-4 h-4 fill-current text-amber-600" />
                  ))}
                </div>
