...
import { Award, CheckCircle2, TrendingUp, Users, ArrowUpRight, Star } from "lucide-react";
  ...
  const tiers = [
    {
      ...
      description:
        "High-reach authority creators with verified 3-second hook retention and massive organic conversion track records.",
      metrics: [
    ...
    },
    {
      ...
      description:
        "Consistent, high-velocity creators delivering frame-accurate commercial assets with dependable turnaround times.",
      metrics: [
    ...
    },
    {
      ...
      description:
        "Rising organic storytellers and UGC specialists offering high-volume authentic product demonstrations at competitive rates.",
      metrics: [
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 space-y-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {tiers.map((tier, i) => (
            <div
              key={i}
              className={`bg-white/95 border-2 rounded-3xl p-7 flex flex-col justify-between space-y-6 ${tier.cardBorder} hover:border-[#66101b] transition-all`}
            >
                ...
                <div className="space-y-2 pt-2">
                  ...
                  <div className="space-y-1.5">
                    {tier.perks.map((perk, idx) => (
                      <div key={idx} className="flex items-start gap-2 text-xs text-[#82575c]">
              ...
              <div className="pt-4 border-t border-[#e4d0c0] space-y-2">
                ...
                <div className="flex flex-wrap gap-2">
                  {tier.featuredCreators.map((c, idx) => (
                    <span
                      key={idx}
                      className="text-[11px] font-mono bg-[#faf3eb] px-2.5 py-1 rounded-lg border border-[#e4d0c0] text-[#66101b]"
                    >
                      {c.name} • {c.reach}
                    </span>
                  ))}
